...
final class EntityParams extends ContentParams implements ContentParamsInterface
{
    ...
    public function getContent(): mixed
    {
        return match ($this->target) {
            ...
            'book_weekdays_restricted' => $this->getCalendarJson(),
            'color' => Check::color($this->asString()),
            'book_max_minutes', 'book_max_slots', 'book_is_cancellable', 'book_cancel_minutes', 'book_min_start_time', 'book_max_end_time', 'content_type', 'proc_pack_qty', 'rating', 'userid' => $this->asInt(),
            'state' => $this->getState(),
